...
public class PowerOutageDAO {
	...
	public static List<Nerc> getNercList() {
	...
	public static List<PowerOutage> getPowerOutagesByNerc(Nerc nerc){
		...
		try {
			...
			while (res.next()) {
				PowerOutage n = new PowerOutage(res.getInt("nerc_id"), res.getInt("customers_affected"), 
